...
export default function App() {
  return (
    React.createElement(Routes, null,
      ...
      React.createElement(Route, { path: '/unauthorized', element: React.createElement(Unauthorized, null) }),
      React.createElement(Route, { path: '/', element: React.createElement(ProtectedRoute, null, React.createElement(Layout, null)), children:
        React.createElement(React.Fragment, null,
          ...
          React.createElement(Route, { path: 'audit', element: React.createElement(ProtectedRoute, { perm: 'system.audit.view' }, React.createElement(Audit, null)) }),
          React.createElement(Route, { path: 'files', element: React.createElement(Files, null) }),
          React.createElement(Route, { path: 'settings', element: React.createElement(ProtectedRoute, { perm: 'system.config.update' }, React.createElement(Settings, null)) }),
          React.createElement(Route, { path: 'notifications', element: React.createElement(Notifications, null) }),
          React.createElement(Route, { path: 'reports', element: React.createElement(ProtectedRoute, { perm: ['reports.view', 'finance.reports.view'] }, React.createElement(Reports, null)) }),
