...
const deliveryReceiptsRoutes = require('./src/routes/deliveryReceipts')
...
app.use('/bale-purchase-orders', balePurchaseOrdersRoutes) // compatibility alias — same router as /bale-purchases
app.use('/bale-returns', baleReturnsRoutes)
app.use('/api/delivery-receipts', deliveryReceiptsRoutes)
